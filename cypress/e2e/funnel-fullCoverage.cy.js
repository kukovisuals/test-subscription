...
for(let index = 0; index < 8; index++){
  ...
  describe(`Subscription Funnel for Full Coverage size ${size[index]} and Mix Colors`, () => {
...
for(let index = 1; index < 5; index++){
  ...
  describe(`Subscription Funnel for Full Coverage size ${size[index]} Natural Colors`, () => {
